  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['base:evaluate:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['base:evaluate:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <!-- <el-table-column label="评价id" align="center" prop="evaluateId" />
        <el-table-column label="评价人" align="center" prop="userId" /> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="评价人" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入评价人" />
        </el-form-item>
        <el-form-item label="评分" prop="score">
...
import {
  ...
  addEvaluate,
  updateEvaluate
} from '@/api/evalueate/evalueate.js'
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除课程评价编号为"' + evaluateIds + '"的数据项？')
        .then(function () {
