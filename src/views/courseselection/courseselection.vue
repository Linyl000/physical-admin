  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['work:stuCourceSester:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否删除0:否   1 :删除" prop="delFlag">
          <el-input
            v-model="form.delFlag"
            placeholder="请输入是否删除0:否   1 :删除"
          />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
      ...
      this.$refs['form'].validate((valid) => {
        if (valid) {
          if (this.form.id != null) {
            ...
            addStuCourceSester(this.form).then((response) => {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除学生选课编号为"' + ids + '"的数据项？')
        .then(function () {
    ...
    handleExport() {
      this.download(
        'work/stuCourceSester/export',
        {
          ...this.queryParams
        },
        `stuCourceSester_${new Date().getTime()}.xlsx`
      )
    }
  }
}
